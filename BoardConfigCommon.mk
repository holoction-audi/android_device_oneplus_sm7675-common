...
PREBUILT_DTB_DTBO_DIR := device/oneplus/audi-prebuilt/images
BOARD_PREBUILT_DTBIMAGE_DIR := $(PREBUILT_DTB_DTBO_DIR)/dtbs/
BOARD_PREBUILT_DTBOIMAGE := $(wildcard $(PREBUILT_DTB_DTBO_DIR)/dtbo.img)
